...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'News'
        db.create_table('cmsplugin_news_news_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('news', models.ForeignKey(orm['cmsplugin_news.news'], null=False)),
            ('tag', models.ForeignKey(orm['tagging.tag'], null=False))
        ))
        db.create_unique('cmsplugin_news_news_tags', ['news_id', 'tag_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field tags on 'News'
        db.delete_table('cmsplugin_news_news_tags')
    ...
    models = {
        ...
        'cmsplugin_news.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 29, 21, 1, 13, 463284)'}),
