...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'News.unpub_date'
        db.add_column('cmsplugin_news_news', 'unpub_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'News.unpub_date'
        db.delete_column('cmsplugin_news_news', 'unpub_date')
    ...
    models = {
        ...
        'cmsplugin_news.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 11, 15, 0, 33, 669509)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['tagging.Tag']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'unpub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
